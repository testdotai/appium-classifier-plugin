...
const DEBUG_IMAGES = false; // set to 'true' to write out images
const DEBUG_IMAGE_DIR = `${process.env.HOME}/elements`; // change to your dir
...
async function predictionFromImage (imgData, confidence, labelHint) {
